...
# ===================== TENTANG =====================
    ...
    <div class="highlight-box">
    Dashboard ini dikembangkan sebagai media edukasi kepabeanan berbasis materi resmi
    DJBC untuk mendukung literasi masyarakat serta kegiatan akademik dan magang
    di lingkungan Direktorat Jenderal Bea dan Cukai Wilayah Aceh.
    <br><br>
